...
ActiveRecord::Schema.define(version: 20160920023737) do
  ...
  create_table "ratingcompanies", force: :cascade do |t|
    t.integer  "value"
    t.integer  "work_id"
  ...
  add_index "ratingcompanies", ["category_id"], name: "index_ratingcompanies_on_category_id", using: :btree
  add_index "ratingcompanies", ["work_id"], name: "index_ratingcompanies_on_work_id", using: :btree
  ...
  add_foreign_key "ratingcompanies", "categories"
  add_foreign_key "ratingcompanies", "works"
