...
(function() {
  ...
  WorkerHistory = (function() {
    function WorkerHistory() {
      this.init();
    }

    WorkerHistory.prototype.init = function() {
      $(document).foundation();
      return this.workerModalHandler();
    };

    WorkerHistory.prototype.workerModalHandler = function() {
      return $('[data-trigger-modal]').on('click', function(e) {
        var work_id;
        e.preventDefault();
        e.stopPropagation();
        ...
        $.ajax({
          ...
          var company_comments, company_name, end_date, start_date, worker_comments;
          console.log(data);
  ...
  $(document).on('turbolinks:load', function(e) {
    return window.theme = new WorkerHistory();
  });
